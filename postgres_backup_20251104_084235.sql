...
\restrict WnKMuuVFo2iDxY3geSzITHty8bUPFNj6FeGsv1VLCiTgfPmlQyTCnf9d68B4tOO
...
ALTER TABLE IF EXISTS ONLY public.feedback DROP CONSTRAINT IF EXISTS feedback_booking_id_fkey;
...
DROP INDEX IF EXISTS public.ix_feedback_user_id;
DROP INDEX IF EXISTS public.ix_feedback_feedback_id;
DROP INDEX IF EXISTS public.ix_feedback_booking_id;
...
ALTER TABLE IF EXISTS public.feedback ALTER COLUMN feedback_id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.feedback_feedback_id_seq;
...
CREATE TABLE public.feedback (
    ...
    CONSTRAINT feedback_rating_between_1_5 CHECK (((rating >= 1) AND (rating <= 5)))
);
...
COPY public.feedback (feedback_id, booking_id, user_id, rating, comment, feedback_date, reply) FROM stdin;
2	48	1	5	awesome	2025-11-04 06:47:41.209843+05:30	yes, thank you for feedback
\.
...
--
-- Name: ix_feedback_booking_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_feedback_booking_id ON public.feedback USING btree (booking_id);


--
-- Name: ix_feedback_feedback_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_feedback_feedback_id ON public.feedback USING btree (feedback_id);
...
\unrestrict WnKMuuVFo2iDxY3geSzITHty8bUPFNj6FeGsv1VLCiTgfPmlQyTCnf9d68B4tOO
